...
try:
    ...
    try:
        ...
        print ('%s fuzzywuzzy has been installed, restart XSS Black4Silent.' % info)
        quit()
except ImportError:  # throws error in python2
    print('%s XSS Black4Silent isn\'t compatible with python2.\n Use python > 3.4 to run XSS Black4Silent.' % bad)
    quit()
